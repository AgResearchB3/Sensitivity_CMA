...
setwd('/home/mariona/Documents/00_2018/00_Validations/climex-for-linux')
...
climex_mcr_dir <- '/home/mariona/Documents/00_2018/00_Validations/climex-for-linux/mcr_cpp_for_mariona' 
...
for (i in 1: iterations) {
	...
	#old_bat
	old_sh <- readLines(paste(climex_mcr_dir, join_out_files_sh_fname, sep = '/'))
	old_sh
	#new_bat <- gsub('([0-9])', i, old_bat)
	#new_bat
	new_sh <- gsub('([0-9])', i, old_sh)
	new_sh
	...
	# Write the new sh file to disc
	cat(new_sh, file = paste(climex_mcr_dir, join_out_files_sh_fname, sep = '/'), sep = '\n')
